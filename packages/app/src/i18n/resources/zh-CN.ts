...
export const zhCN: TranslationResources = {
  ...
  agentControls: {
    ...
    features: {
      ...
      known: {
        ...
        plan_mode: {
          label: "计划",
          description: "将 Codex 切换为只制定计划的协作模式",
          tooltip: "切换计划模式",
        },
        ultracode: {
          label: "Ultracode",
  ...
  modelDescriptions: {
    "gpt-5_6-sol": "最新前沿智能体编程模型。",
    "gpt-5_6-terra": "均衡的日常智能体编程模型。",
    "gpt-5_6-luna": "快速且实惠的智能体编程模型。",
    "gpt-5_5": "适合复杂编程、研究与实际工作的前沿模型。",
    "gpt-5_4": "适合日常编程的强力模型。",
    "gpt-5_4-mini": "小巧快速、性价比高，适合较简单的编程任务。",
    "gpt-5_2": "面向专业工作与长时运行智能体优化。",
    "claude-fable-5": "Fable 5 · 最强模型",
    "claude-opus-4-8_1m_": "Opus 4.8，100 万上下文窗口",
    "claude-opus-4-8": "Opus 4.8 · 最新版本",
    "claude-sonnet-5": "Sonnet 5 · 日常任务首选",
    "claude-opus-4-7_1m_": "Opus 4.7，100 万上下文窗口",
    "claude-opus-4-7": "Opus 4.7 · 上一版本",
    "claude-opus-4-6_1m_": "Opus 4.6，100 万上下文窗口",
    "claude-opus-4-6": "Opus 4.6 · 复杂任务最强",
  ...
  providerUsage: {
    ...
    empty: "暂无用量数据",
    errorTitle: "无法加载用量",
    hostUnavailable: "连接此主机后可查看提供商用量",
    hostUpgradeRequired: "请更新主机以查看提供商用量",
  ...
  grokAccounts: {
    title: "Grok 账号",
    addAccount: "添加账号",
    addFromDesktopHint: "请在主机上的 Paseo 桌面端添加账号。",
    active: "使用中",
    switchAction: "切换到 {{name}}",
    quotaUnknown: "额度未知",
    quotaLine: "{{used}} / {{total}} 额度",
    weeklyUsed: "本周已用 {{percent}}%",
    resetsOn: "{{date}} 重置",
    breakdown: "{{summary}}",
    category: {
      build: "Grok Build",
    ...
    needsReauth: "登录已过期——请重新添加该账号以刷新。",
    emptyTitle: "尚未保存 Grok 账号",
    emptyBody: "登录 Grok，即可随时随地在多个账号之间切换。",
    unsavedCurrent: "当前登录（未保存）——{{email}}",
    unknownEmail: "未知",
    removeAction: "移除",
    removeConfirmTitle: "移除账号",
    removeConfirmBody: "要把 {{name}} 从 Paseo 移除吗？保存的登录信息会从该主机删除。",
    removeAnyway: "移除",
    removeActiveTitle: "移除正在使用的账号？",
    removeActiveBody:
      "该主机上的 Grok 仍保持登录——Paseo 只是忘掉已保存的副本。之后要切回来需要重新登录。系统会先写入一份备份。",
    switchBlockedTitle: "有智能体正在运行，仍要切换吗？",
    switchBlockedBody:
      "Grok 每次请求前都会重新加载登录信息，所以正在运行的智能体可能会在对话中途改用新账号。Paseo 看不到不是它启动的 grok 进程。",
    switchAnyway: "仍然切换",
    managedConfig: "切换已禁用——该主机使用的是托管的 Grok 配置。",
    hostUpgradeRequired: "请更新主机以管理 Grok 账号",
    cliMissing: "主机上未找到 Grok Build 命令行工具。",
    login: {
      waiting: "正在打开浏览器登录 Grok……",
      completed: "已添加账号——{{email}}",
      makeActive: "立即设为使用中",
      done: "完成",
      failed: "登录未完成",
      timeout: "登录超时，请重试。",
      alreadyInProgress: "已有一个 Grok 登录正在进行，请先完成或取消后再重试。",
      tryAgain: "重试",
      cancel: "取消",
      openSignIn: "打开登录页面",
      chooseTitle: "选择登录方式",
      methodDevice: "复制链接登录",
      methodDeviceHint: "拿到链接和验证码，复制到任意浏览器打开登录（适合多账号）",
      methodBrowser: "本机浏览器登录",
      methodBrowserHint: "自动在这台电脑的浏览器打开登录页",
      deviceInstructions: "复制下面的链接到浏览器打开，输入验证码完成登录",
      copyLink: "复制链接",
      copyCode: "复制验证码",
      copied: "已复制",
      codeLabel: "验证码",
      waitingBrowser: "正在本机浏览器打开登录页…",
    },
  },
  review: {
    comment: {
  ...
  settings: {
    ...
    diagnostics: {
      ...
      app: {
        title: "应用诊断",
        rowTitle: "应用诊断",
        rowHint: "收集连接、daemon、提供方、桌面端和日志详情",
        run: "运行",
        running: "正在运行诊断...",
        copyLabel: "诊断",
    ...
    host: {
      ...
      terminalProfiles: {
        unavailable: "连接此 Host 后才能管理终端配置",
        sectionTitle: "终端配置",
        editProfile: "编辑配置",
      ...
      daemon: {
        ...
        update: {
          ...
          confirmMessage: "这会将 daemon 更新到最新版本并重启。运行中的 Agent 会短暂中断。",
          updating: "正在更新...",
