...
export const ja: TranslationResources = {
  ...
  providerUsage: {
    ...
    hostUnavailable: "プロバイダー使用量を表示するには、このホストに接続してください",
    hostUpgradeRequired: "プロバイダー使用量を表示するにはホストを更新してください",
  ...
  grokAccounts: {
    title: "Grok アカウント",
    addAccount: "アカウントを追加",
    addFromDesktopHint: "ホストマシンの Paseo デスクトップアプリからアカウントを追加してください。",
    active: "使用中",
    switchAction: "{{name}} に切り替え",
    quotaUnknown: "クォータ不明",
    quotaLine: "{{used}} / {{total}} クレジット",
    weeklyUsed: "今週 {{percent}}% 使用",
    resetsOn: "{{date}} にリセット",
    breakdown: "{{summary}}",
    category: {
      build: "Grok Build",
    ...
    needsReauth: "サインインの有効期限が切れました。このアカウントを再度追加して更新してください。",
    emptyTitle: "保存された Grok アカウントはありません",
    emptyBody: "Grok にサインインすると、どこからでもアカウントを切り替えられます。",
    unsavedCurrent: "現在のサインイン（未保存）— {{email}}",
    unknownEmail: "不明",
    removeAction: "削除",
    removeConfirmTitle: "アカウントを削除",
    removeConfirmBody:
      "{{name}} を Paseo から削除しますか？保存されたサインインはこのホストから削除されます。",
    removeAnyway: "削除",
    removeActiveTitle: "使用中のアカウントを削除しますか？",
    removeActiveBody:
      "このホストの Grok はサインインしたままです。Paseo は保存されたコピーを忘れるだけです。後で切り替え直すには再度サインインが必要です。先にバックアップが書き込まれます。",
    switchBlockedTitle: "エージェントの実行中に切り替えますか？",
    switchBlockedBody:
      "Grok はリクエストごとにサインインを再読み込みするため、実行中のエージェントが会話の途中で新しいアカウントに切り替わる場合があります。Paseo は自身が起動していない grok プロセスを認識できません。",
    switchAnyway: "それでも切り替える",
    managedConfig: "切り替えは無効です。このホストは管理された Grok 構成を使用しています。",
    hostUpgradeRequired: "Grok アカウントを管理するにはホストを更新してください",
    cliMissing: "ホストに Grok Build CLI が見つかりません。",
    login: {
      waiting: "Grok にサインインするためブラウザーを開いています…",
      completed: "アカウントを追加しました — {{email}}",
      makeActive: "今すぐ使用中にする",
      done: "完了",
      failed: "サインインが完了しませんでした",
      timeout: "サインインがタイムアウトしました。もう一度お試しください。",
      alreadyInProgress:
