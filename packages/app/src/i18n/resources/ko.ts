...
export const ko: TranslationResources = {
  ...
  agentControls: {
    ...
    features: {
      ...
      known: {
        fast_mode: {
          label: "빠름",
          description: "더 높은 토큰 비용으로 더 낮은 대기 시간 응답",
          tooltip: "빠른 모드 전환",
        },
        plan_mode: {
          label: "계획",
          description: "Codex를 계획 전용 협업 모드로 전환",
          tooltip: "계획 모드 전환",
        },
        ultracode: {
          label: "Ultracode",
          description: "Claude의 동적 워크플로우 오케스트레이션에 초고강도 사용",
          tooltip: "Ultracode 전환",
        },
      },
    },
    mode: {
    ...
    gateway: {
      nativeLabel: "네이티브",
      fallbackLabel: "모델 게이트웨이",
      sheetTitle: "모델 게이트웨이",
      selectAccessibilityLabel: "모델 게이트웨이 선택",
      selectAccessibilityLabelWithValue: "모델 게이트웨이 선택 ({{value}})",
    },
    cluster: {
      title: "클러스터",
      on: "켜짐",
      off: "꺼짐",
      hint: "켜짐: 메인 에이전트가 주도합니다 — 대화에서 계획하고 사이드바에서 볼 수 있는 병렬 워커에게 작업을 위임한 후 결과를 요약합니다. 작은 요청은 직접 답하며 언제든지 계속 대화할 수 있습니다.",
      unsupported: "클러스터 모드를 사용하려면 호스트를 업그레이드하세요",
    },
  },
  agentStream: {
  ...
  message: {
    ...
    footer: {
      workedFor: "{{duration}} 동안 작업",
      durationEndedAt: "{{duration}}, {{timestamp}}에 종료",
      tokenRate: "{{rate}} token/초",
    },
  },
  importSession: {
    title: "세션 가져오기",
  ...
  workspace: {
    ...
    tabs: {
      ...
      menu: {
        ...
        agentRecallPrompt:
          "이 세션의 컨텍스트를 이어가세요: {{id}}\n먼저 ccswitch-resume으로 회상한 후 계속하세요.",
  ...
  sidebar: {
    ...
    sessionsList: {
      ...
      newAgentInWorkspace: "이 워크스페이스에서 새 에이전트",
      history: "세션 기록",
      empty: "세션이 없습니다",
      unknownWorkspace: "기타",
  ...
  desktop: {
    ...
    integrations: {
      ...
      sharedContext: {
        statusFailed: "공유 AI 컨텍스트를 확인할 수 없습니다.",
        syncFailed: "공유 AI 컨텍스트를 동기화하지 못했습니다.",
      },
    },
  },
  rootError: {
  ...
  swarmBoard: {
    title: "스웜 보드",
    openAction: "스웜 보드 열기",
    openTooltip: "모든 하위 에이전트를 라이브 카드로 보기",
    showListAction: "목록 표시",
    showListTooltip: "이 세션 내에서 간결한 하위 에이전트 목록으로 전환",
    showBoardAction: "보드 표시",
    showBoardTooltip: "이 세션 내에서 라이브 하위 에이전트 카드 표시",
    graphView: "그래프",
    showGraphAction: "그래프 표시",
    showGraphTooltip: "스웜 협업 그래프 표시",
    empty: "아직 하위 에이전트가 없습니다",
    toolCalls: "도구 호출 {{count}}개",
    status: {
      running: "실행 중",
      completed: "완료됨",
      failed: "실패",
    ...
    lastActivityNone: "아직 활동 없음",
    inlineHeader: "도우미 {{count}}개 | {{title}}",
  },
  panels: {
    draft: {
      newAgent: "새 에이전트",
  ...
  modelDescriptions: {
    "gpt-5_6-sol": "최신 프론티어 에이전트 코딩 모델.",
    "gpt-5_6-terra": "일상 작업을 위한 균형 잡힌 에이전트 코딩 모델.",
    "gpt-5_6-luna": "빠르고 저렴한 에이전트 코딩 모델.",
    "gpt-5_5": "복잡한 코딩, 연구, 실제 작업을 위한 프론티어 모델.",
    "gpt-5_4": "일상적인 코딩을 위한 강력한 모델.",
    "gpt-5_4-mini": "간단한 코딩 작업을 위한 작고 빠르고 비용 효율적인 모델.",
    "gpt-5_2": "전문 작업과 장기 실행 에이전트에 최적화됨.",
    "claude-fable-5": "Fable 5 · 가장 강력한 모델",
    "claude-opus-4-8_1m_": "1M 컨텍스트 윈도우의 Opus 4.8",
    "claude-opus-4-8": "Opus 4.8 · 최신 릴리스",
    "claude-sonnet-5": "Sonnet 5 · 일상 작업에 최적",
    "claude-opus-4-7_1m_": "1M 컨텍스트 윈도우의 Opus 4.7",
    "claude-opus-4-7": "Opus 4.7 · 이전 릴리스",
    "claude-opus-4-6_1m_": "1M 컨텍스트 윈도우의 Opus 4.6",
    "claude-opus-4-6": "Opus 4.6 · 복잡한 작업에 가장 적합",
    "claude-sonnet-4-6_1m_": "1M 컨텍스트 윈도우의 Sonnet 4.6",
    "claude-sonnet-4-6": "Sonnet 4.6 · 일상 작업에 최적",
    "claude-haiku-4-5": "Haiku 4.5 · 빠른 답변에 가장 빠름",
    "claude-fable-5_1m_": "1M 컨텍스트 윈도우의 Fable 5",
    "grok-4_5": "SpaceXAI의 새로운 프론티어 모델",
    "grok-composer-2_5-fast": "Cursor의 최신 코딩 모델",
  },
  providerUsage: {
    title: "플랜 사용량",
    refresh: "새로고침",
    ...
    hostUnavailable: "이 호스트에 연결하면 프로바이더 사용량을 볼 수 있습니다",
  ...
  grokAccounts: {
    title: "Grok 계정",
    addAccount: "계정 추가",
    addFromDesktopHint: "호스트 컴퓨터의 Paseo 데스크톱 앱에서 계정을 추가하세요.",
    active: "활성",
    switchAction: "{{name}}(으)로 전환",
    quotaUnknown: "할당량 알 수 없음",
    quotaLine: "{{used}} / {{total}} 크레딧",
    weeklyUsed: "이번 주 {{percent}}% 사용됨",
    resetsOn: "{{date}}에 초기화",
    breakdown: "{{summary}}",
    category: {
      build: "Grok Build",
    ...
    needsReauth: "로그인 만료 — 계정을 다시 추가하여 새로고침하세요.",
    emptyTitle: "저장된 Grok 계정이 없습니다",
    emptyBody: "Grok에 로그인하면 어디서나 계정 간에 전환할 수 있습니다.",
    unsavedCurrent: "현재 로그인 (저장되지 않음) — {{email}}",
    unknownEmail: "알 수 없음",
    removeAction: "제거",
    removeConfirmTitle: "계정 제거",
    removeConfirmBody:
      "Paseo에서 {{name}}을(를) 제거할까요? 저장된 로그인이 이 호스트에서 삭제됩니다.",
    removeAnyway: "제거",
    removeActiveTitle: "활성 계정을 제거할까요?",
    removeActiveBody:
      "이 호스트의 Grok은 로그인 상태로 유지됩니다 — Paseo는 저장된 복사본만 잊어버립니다. 나중에 다시 전환하려면 새 로그인이 필요합니다. 먼저 백업이 작성됩니다.",
    switchBlockedTitle: "에이전트가 실행 중일 때 전환할까요?",
    switchBlockedBody:
      "Grok은 모든 요청 전에 로그인을 다시 로드하므로, 실행 중인 에이전트가 대화 도중 새 계정으로 계속될 수 있습니다. Paseo는 시작하지 않은 grok 프로세스를 볼 수 없습니다.",
    switchAnyway: "그래도 전환",
    managedConfig: "전환이 비활성화됨 — 이 호스트는 관리형 Grok 구성을 사용합니다.",
    hostUpgradeRequired: "Grok 계정을 관리하려면 호스트를 업데이트하세요",
    cliMissing: "호스트에서 Grok Build CLI를 찾을 수 없습니다.",
    login: {
      waiting: "Grok에 로그인하기 위해 브라우저를 여는 중…",
      completed: "계정 추가됨 — {{email}}",
      makeActive: "지금 활성화",
      done: "완료",
      failed: "로그인이 완료되지 않았습니다",
      timeout: "로그인 시간이 초과되었습니다. 다시 시도하세요.",
      alreadyInProgress:
        "다른 Grok 로그인이 이미 진행 중입니다. 완료하거나 취소한 후 다시 시도하세요.",
      tryAgain: "다시 시도",
      cancel: "취소",
      openSignIn: "로그인 페이지 열기",
      chooseTitle: "로그인 방법 선택",
      methodDevice: "복사된 링크로 로그인",
      methodDeviceHint:
        "링크와 코드를 받은 후 아무 브라우저에서 열어 로그인합니다 (여러 계정에 적합)",
      methodBrowser: "이 컴퓨터의 브라우저로 로그인",
      methodBrowserHint: "이 컴퓨터의 브라우저에서 로그인 페이지를 자동으로 엽니다",
      deviceInstructions: "아래 링크를 브라우저에 붙여넣고 코드를 입력하여 로그인을 완료하세요",
      copyLink: "링크 복사",
      copyCode: "코드 복사",
      copied: "복사됨",
      codeLabel: "인증 코드",
      waitingBrowser: "이 컴퓨터의 브라우저에서 로그인 페이지를 여는 중…",
    },
  },
  review: {
    comment: {
  ...
  settings: {
    ...
    general: {
      ...
      autoTranslateReasoning: {
        label: "추론 자동 번역",
        description: "모델이 영어로 추론한 후 완료되면 자동으로 번역합니다",
        translating: "추론을 번역하는 중…",
        translatedBadge: "번역됨",
    ...
    appearance: {
      newTheme: {
        title: "새 테마",
        label: "새 테마 사용",
        hint: "아래 테마와 독립적으로 앱 전체에 재설계된 라이트 룩을 적용합니다",
        accessibilityLabel: "새 테마 사용",
      },
      theme: {
        title: "테마",
    ...
    integrations: {
      ...
      sharedContext: {
        title: "공유 AI 컨텍스트",
        description: "감지된 AI 클라이언트가 단일 프롬프트, 스킬 및 MCPProxy를 공유하도록 합니다",
        ready: "감지된 {{count}}개 AI 클라이언트가 공유 컨텍스트를 사용 중입니다",
        drift: "감지된 {{count}}개 AI 클라이언트 중 {{ready}}개가 동기화되었습니다",
        proxyOffline: "MCPProxy가 실행되지 않았습니다. 먼저 시작한 후 동기화하세요",
        syncTitle: "공유 AI 컨텍스트를 동기화할까요?",
        syncMessage:
          "변경된 클라이언트 파일을 먼저 백업한 후 ~/.ai-shared에 연결합니다. 클라이언트의 개인 스킬과 기존 MCP 항목은 유지됩니다.",
      },
      actions: {
        install: "설치",
        installing: "설치 중...",
