...
export const es: TranslationResources = {
  ...
  agentControls: {
    ...
    cluster: {
      ...
      on: "On",
      off: "Off",
      hint: "Activado: el agente principal lidera: planifica en el chat, delega en trabajadores paralelos que puedes ver en la barra lateral y resume los resultados. Las preguntas sencillas se responden directamente y puedes seguir conversando en cualquier momento.",
  ...
  workspace: {
    ...
    tabs: {
      ...
      menu: {
        ...
        copyAgentId: "Copiar prompt de reanudación",
        agentRecallPrompt:
  ...
  swarmBoard: {
    title: "Panel Swarm",
    openAction: "Abrir panel Swarm",
    openTooltip: "Ver todos los subagentes como tarjetas en vivo",
    ...
    lastActivityNone: "Aún no hay actividad",
  ...
  modelDescriptions: {
    ...
    "gpt-5_5": "Frontier model for complex coding, research, and real-world work.",
    "gpt-5_4": "Strong model for everyday coding.",
    "gpt-5_4-mini": "Small, fast, and cost-efficient model for simpler coding tasks.",
    "gpt-5_2": "Optimized for professional work and long-running agents.",
    "claude-fable-5": "Fable 5 · Most powerful model",
    "claude-opus-4-8_1m_": "Opus 4.8 with 1M context window",
    "claude-opus-4-8": "Opus 4.8 · Latest release",
    "claude-sonnet-5": "Sonnet 5 · Best for everyday tasks",
    "claude-opus-4-7_1m_": "Opus 4.7 with 1M context window",
    "claude-opus-4-7": "Opus 4.7 · Previous release",
    "claude-opus-4-6_1m_": "Opus 4.6 with 1M context window",
  ...
  providerUsage: {
    ...
    hostUnavailable: "Conéctate a este anfitrión para ver el uso del proveedor",
    hostUpgradeRequired: "Actualiza el anfitrión para ver el uso del proveedor",
    clientUnavailable: "La conexión con el anfitrión no está lista",
    retry: "Reintentar",
    tooltipLoading: "Cargando uso del plan…",
  },
  grokAccounts: {
    title: "Cuentas de Grok",
    addAccount: "Añadir cuenta",
    addFromDesktopHint:
      "Añade cuentas desde la app de escritorio de Paseo en la máquina anfitriona.",
    active: "Activa",
    switchAction: "Cambiar a {{name}}",
    quotaUnknown: "Cuota desconocida",
    quotaLine: "{{used}} / {{total}} créditos",
    weeklyUsed: "{{percent}}% usado esta semana",
    resetsOn: "se restablece {{date}}",
    breakdown: "{{summary}}",
    category: {
      build: "Grok Build",
      api: "API",
    ...
    needsReauth: "La sesión caducó: vuelve a añadir esta cuenta para actualizarla.",
    emptyTitle: "No hay cuentas de Grok guardadas",
    emptyBody: "Inicia sesión en Grok para cambiar de cuenta desde cualquier lugar.",
    unsavedCurrent: "Sesión actual (sin guardar) — {{email}}",
    unknownEmail: "desconocido",
    removeAction: "Quitar",
    removeConfirmTitle: "Quitar cuenta",
    removeConfirmBody:
      "¿Quitar {{name}} de Paseo? La sesión guardada se elimina de este anfitrión.",
    removeAnyway: "Quitar",
    removeActiveTitle: "¿Quitar la cuenta activa?",
    removeActiveBody:
      "Grok en este anfitrión sigue con la sesión iniciada; Paseo solo olvida la copia guardada. Volver a cambiar más tarde requiere iniciar sesión de nuevo. Primero se escribe una copia de seguridad.",
    switchBlockedTitle: "¿Cambiar con agentes en ejecución?",
    switchBlockedBody:
      "Grok recarga su sesión antes de cada solicitud, así que los agentes en ejecución pueden continuar con la nueva cuenta a mitad de la conversación. Paseo no ve los procesos de grok que no inició.",
    switchAnyway: "Cambiar de todos modos",
    managedConfig:
      "El cambio está deshabilitado: este anfitrión usa una configuración de Grok gestionada.",
    hostUpgradeRequired: "Actualiza el anfitrión para gestionar cuentas de Grok",
    cliMissing: "No se encontró la CLI de Grok Build en el anfitrión.",
    login: {
      waiting: "Abriendo el navegador para iniciar sesión en Grok…",
      completed: "Cuenta añadida — {{email}}",
      makeActive: "Activarla ahora",
      done: "Listo",
      failed: "El inicio de sesión no se completó",
      timeout: "El inicio de sesión agotó el tiempo. Inténtalo de nuevo.",
      alreadyInProgress:
        "Another Grok sign-in is already in progress. Finish or cancel it, then try again.",
      tryAgain: "Reintentar",
      cancel: "Cancelar",
      openSignIn: "Abrir la página de inicio de sesión",
      chooseTitle: "Choose how to sign in",
      methodDevice: "Iniciar sesión con un enlace copiado",
      methodDeviceHint:
        "Get a link and code, then open it in any browser to sign in (best for multiple accounts)",
      methodBrowser: "Iniciar sesión con el navegador de este equipo",
      methodBrowserHint: "Opens the sign-in page in this computer's browser automatically",
      deviceInstructions:
        "Copy the link below into a browser, then enter the code to finish signing in",
      copyLink: "Copy link",
      copyCode: "Copy code",
      copied: "Copied",
      codeLabel: "Verification code",
      waitingBrowser: "Opening the sign-in page in this computer's browser…",
    },
  },
  review: {
    comment: {
