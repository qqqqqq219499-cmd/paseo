...
export const ar: TranslationResources = {
  ...
  grokAccounts: {
    ...
    addFromDesktopHint: "أضِف الحسابات من تطبيق Paseo لسطح المكتب على الجهاز المضيف.",
    active: "نشط",
    switchAction: "التبديل إلى {{name}}",
    quotaUnknown: "الحصة غير معروفة",
    quotaLine: "{{used}} / {{total}} رصيد",
    weeklyUsed: "تم استخدام {{percent}}% هذا الأسبوع",
    resetsOn: "تتم إعادة التعيين {{date}}",
    breakdown: "{{summary}}",
    category: {
      build: "Grok Build",
      api: "API",
    ...
    needsReauth: "انتهت صلاحية تسجيل الدخول — أضِف هذا الحساب مرة أخرى لتحديثه.",
    emptyTitle: "لا توجد حسابات Grok محفوظة",
    emptyBody: "سجّل الدخول إلى Grok للتبديل بين الحسابات من أي مكان.",
    unsavedCurrent: "تسجيل الدخول الحالي (غير محفوظ) — {{email}}",
    unknownEmail: "غير معروف",
    removeAction: "إزالة",
    removeConfirmTitle: "إزالة الحساب",
    removeConfirmBody:
      "هل تريد إزالة {{name}} من Paseo؟ سيتم حذف تسجيل الدخول المحفوظ من هذا المضيف.",
    removeAnyway: "إزالة",
    removeActiveTitle: "إزالة الحساب النشط؟",
    removeActiveBody:
      "يبقى Grok على هذا المضيف مسجّلاً الدخول — ينسى Paseo النسخة المحفوظة فقط. يتطلب التبديل لاحقًا تسجيل دخول جديد. تُكتب نسخة احتياطية أولاً.",
    switchBlockedTitle: "التبديل أثناء تشغيل الوكلاء؟",
    switchBlockedBody:
      "يعيد Grok تحميل تسجيل الدخول قبل كل طلب، لذا قد يتابع الوكلاء العاملون الآن على الحساب الجديد أثناء المحادثة. لا يرى Paseo عمليات grok التي لم يبدأها.",
    switchAnyway: "التبديل على أي حال",
    managedConfig: "التبديل معطّل — يستخدم هذا المضيف إعداد Grok مُدارًا.",
    hostUpgradeRequired: "حدّث المضيف لإدارة حسابات Grok",
    cliMissing: "لم يتم العثور على أداة Grok Build على المضيف.",
    login: {
      waiting: "يتم فتح المتصفح لتسجيل الدخول إلى Grok…",
      completed: "تمت إضافة الحساب — {{email}}",
      makeActive: "تفعيله الآن",
      done: "تم",
      failed: "لم يكتمل تسجيل الدخول",
      timeout: "انتهت مهلة تسجيل الدخول. حاول مرة أخرى.",
      alreadyInProgress:
      ...
      methodDevice: "تسجيل الدخول عبر رابط منسوخ",
      methodDeviceHint:
        "Get a link and code, then open it in any browser to sign in (best for multiple accounts)",
      methodBrowser: "تسجيل الدخول عبر متصفح هذا الكمبيوتر",
