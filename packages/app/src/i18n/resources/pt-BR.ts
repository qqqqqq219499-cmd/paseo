...
export const ptBR: TranslationResources = {
  ...
  grokAccounts: {
    title: "Contas do Grok",
    addAccount: "Adicionar conta",
    addFromDesktopHint: "Adicione contas pelo app de desktop do Paseo na máquina host.",
    active: "Ativa",
    switchAction: "Mudar para {{name}}",
    quotaUnknown: "Cota desconhecida",
    quotaLine: "{{used}} / {{total}} créditos",
    weeklyUsed: "{{percent}}% usado nesta semana",
    ...
    needsReauth: "Login expirado — adicione esta conta novamente para atualizá-la.",
    emptyTitle: "Nenhuma conta do Grok salva",
    emptyBody: "Entre no Grok para alternar entre contas de qualquer lugar.",
    unsavedCurrent: "Login atual (não salvo) — {{email}}",
    unknownEmail: "desconhecido",
    removeAction: "Remover",
    removeConfirmTitle: "Remover conta",
    removeConfirmBody: "Remover {{name}} do Paseo? O login salvo é excluído deste host.",
    removeAnyway: "Remover",
    removeActiveTitle: "Remover a conta ativa?",
    removeActiveBody:
      "O Grok neste host continua conectado — o Paseo apenas esquece a cópia salva. Voltar depois exige um novo login. Um backup é gravado antes.",
    switchBlockedTitle: "Mudar com agentes em execução?",
    switchBlockedBody:
      "O Grok recarrega o login antes de cada solicitação, então os agentes em execução podem continuar na nova conta no meio da conversa. O Paseo não vê processos do grok que não iniciou.",
    switchAnyway: "Mudar mesmo assim",
    managedConfig: "A troca está desativada — este host usa uma configuração gerenciada do Grok.",
    hostUpgradeRequired: "Atualize o host para gerenciar contas do Grok",
    cliMissing: "CLI do Grok Build não encontrada no host.",
    login: {
      waiting: "Abrindo o navegador para entrar no Grok…",
      completed: "Conta adicionada — {{email}}",
      makeActive: "Torná-la ativa agora",
      done: "Concluído",
      failed: "O login não foi concluído",
      timeout: "O login expirou. Tente novamente.",
      alreadyInProgress:
      ...
      methodDevice: "Entrar com um link copiado",
      methodDeviceHint:
        "Get a link and code, then open it in any browser to sign in (best for multiple accounts)",
      methodBrowser: "Entrar com o navegador deste computador",
