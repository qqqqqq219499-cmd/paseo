export const en = {
  ...
  grokAccounts: {
    ...
    addFromDesktopHint: "Add accounts from the Paseo desktop app on the host machine.",
    active: "Active",
    switchAction: "Switch to {{name}}",
    quotaUnknown: "Quota unknown",
    quotaLine: "{{used}} / {{total}} credits",
    weeklyUsed: "{{percent}}% used this week",
    ...
    needsReauth: "Sign-in expired — add this account again to refresh it.",
    emptyTitle: "No Grok accounts saved",
    emptyBody: "Sign in to Grok to switch between accounts from anywhere.",
    unsavedCurrent: "Current sign-in (not saved) — {{email}}",
    unknownEmail: "unknown",
    removeAction: "Remove",
    removeConfirmTitle: "Remove account",
    removeConfirmBody: "Remove {{name}} from Paseo? The saved sign-in is deleted from this host.",
    removeAnyway: "Remove",
    removeActiveTitle: "Remove the active account?",
    removeActiveBody:
      "Grok on this host stays signed in — Paseo just forgets the saved copy. Switching back later needs a new sign-in. A backup is written first.",
    switchBlockedTitle: "Switch while agents are running?",
    switchBlockedBody:
      "Grok reloads its sign-in before every request, so agents running now may continue on the new account mid-conversation. Paseo can't see grok processes it didn't start.",
    switchAnyway: "Switch anyway",
    managedConfig: "Switching is disabled — this host uses a managed Grok configuration.",
    hostUpgradeRequired: "Update the host to manage Grok accounts",
    cliMissing: "Grok Build CLI not found on the host.",
    login: {
      waiting: "Opening your browser to sign in to Grok…",
      completed: "Account added — {{email}}",
      makeActive: "Make it active now",
      done: "Done",
      failed: "Sign-in didn't finish",
      timeout: "The sign-in timed out. Try again.",
      alreadyInProgress:
      ...
      methodDevice: "Sign in with a copied link",
      methodDeviceHint:
        "Get a link and code, then open it in any browser to sign in (best for multiple accounts)",
      methodBrowser: "Sign in with this computer's browser",
