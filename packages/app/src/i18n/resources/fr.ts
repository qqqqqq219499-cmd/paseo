...
export const fr: TranslationResources = {
  ...
  grokAccounts: {
    ...
    addFromDesktopHint: "Ajoutez des comptes depuis l'app de bureau Paseo sur la machine hôte.",
    active: "Actif",
    switchAction: "Basculer vers {{name}}",
    quotaUnknown: "Quota inconnu",
    quotaLine: "{{used}} / {{total}} crédits",
    weeklyUsed: "{{percent}} % utilisés cette semaine",
    resetsOn: "réinitialisation {{date}}",
    breakdown: "{{summary}}",
    category: {
      build: "Grok Build",
      api: "API",
    ...
    needsReauth: "Session expirée — ajoutez de nouveau ce compte pour l'actualiser.",
    emptyTitle: "Aucun compte Grok enregistré",
    emptyBody: "Connectez-vous à Grok pour changer de compte où que vous soyez.",
    unsavedCurrent: "Session actuelle (non enregistrée) — {{email}}",
    unknownEmail: "inconnu",
    removeAction: "Retirer",
    removeConfirmTitle: "Retirer le compte",
    removeConfirmBody:
      "Retirer {{name}} de Paseo ? La session enregistrée est supprimée de cet hôte.",
    removeAnyway: "Retirer",
    removeActiveTitle: "Retirer le compte actif ?",
    removeActiveBody:
      "Grok reste connecté sur cet hôte — Paseo oublie seulement la copie enregistrée. Rebasculer plus tard nécessitera une nouvelle connexion. Une sauvegarde est écrite d'abord.",
    switchBlockedTitle: "Basculer pendant que des agents tournent ?",
    switchBlockedBody:
      "Grok recharge sa session avant chaque requête, donc les agents en cours peuvent continuer sur le nouveau compte en pleine conversation. Paseo ne voit pas les processus grok qu'il n'a pas lancés.",
    switchAnyway: "Basculer quand même",
    managedConfig: "La bascule est désactivée — cet hôte utilise une configuration Grok gérée.",
    hostUpgradeRequired: "Mettez à jour l'hôte pour gérer les comptes Grok",
    cliMissing: "CLI Grok Build introuvable sur l'hôte.",
    login: {
      waiting: "Ouverture du navigateur pour vous connecter à Grok…",
      completed: "Compte ajouté — {{email}}",
      makeActive: "L'activer maintenant",
      done: "Terminé",
      failed: "La connexion ne s'est pas terminée",
      ...
      methodDevice: "Se connecter avec un lien copié",
      methodDeviceHint:
        "Get a link and code, then open it in any browser to sign in (best for multiple accounts)",
      methodBrowser: "Se connecter avec le navigateur de cet ordinateur",
