...
export const ru: TranslationResources = {
  ...
  grokAccounts: {
    ...
    addFromDesktopHint: "Добавляйте аккаунты в десктоп-приложении Paseo на хост-машине.",
    active: "Активный",
    switchAction: "Переключиться на {{name}}",
    quotaUnknown: "Квота неизвестна",
    quotaLine: "{{used}} / {{total}} кредитов",
    weeklyUsed: "Использовано {{percent}}% на этой неделе",
    resetsOn: "сброс {{date}}",
    breakdown: "{{summary}}",
    category: {
      build: "Grok Build",
    ...
    needsReauth: "Срок входа истёк — добавьте этот аккаунт снова, чтобы обновить его.",
    emptyTitle: "Нет сохранённых аккаунтов Grok",
    emptyBody: "Войдите в Grok, чтобы переключаться между аккаунтами откуда угодно.",
    unsavedCurrent: "Текущий вход (не сохранён) — {{email}}",
    unknownEmail: "неизвестно",
    removeAction: "Удалить",
    removeConfirmTitle: "Удалить аккаунт",
    removeConfirmBody: "Удалить {{name}} из Paseo? Сохранённый вход будет удалён с этого хоста.",
    removeAnyway: "Удалить",
    removeActiveTitle: "Удалить активный аккаунт?",
    removeActiveBody:
      "Grok на этом хосте остаётся в системе — Paseo лишь забывает сохранённую копию. Чтобы вернуться позже, потребуется новый вход. Сначала записывается резервная копия.",
    switchBlockedTitle: "Переключить, пока работают агенты?",
    switchBlockedBody:
      "Grok перезагружает вход перед каждым запросом, поэтому работающие агенты могут продолжить с новым аккаунтом посреди разговора. Paseo не видит процессы grok, которые запустил не он.",
    switchAnyway: "Всё равно переключить",
    managedConfig: "Переключение отключено — этот хост использует управляемую конфигурацию Grok.",
    hostUpgradeRequired: "Обновите хост, чтобы управлять аккаунтами Grok",
    cliMissing: "CLI Grok Build не найдена на хосте.",
    login: {
      waiting: "Открываем браузер для входа в Grok…",
      completed: "Аккаунт добавлен — {{email}}",
      makeActive: "Сделать активным сейчас",
      done: "Готово",
      failed: "Вход не завершён",
      timeout: "Время входа истекло. Попробуйте снова.",
      alreadyInProgress:
      ...
      methodDevice: "Войти по скопированной ссылке",
      methodDeviceHint:
        "Get a link and code, then open it in any browser to sign in (best for multiple accounts)",
      methodBrowser: "Войти через браузер этого компьютера",
